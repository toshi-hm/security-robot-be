...
5. **ドキュメント整備フォロー (次回セッション予定)**: ファイル管理API仕様にアップロード/削除レスポンスとアーカイブ連携フローの整理を追記し、環境セッション操作APIの停止/再開シーケンスとJobManagerロック整合性を設計書・テスト計画へ反映する。
