...
2. **`../../report/summary/ARCHIVE_20251118-100019.md` & `../../report/summary/DIARY05_SUMMARY.md`** - 開発セッション履歴の要約（アーカイブと最新要約）
3. **`../../report/DIARY06.md`** - 最新の開発セッション記録
...
- 目次も新しいエントリをリストの一番上に追加
- 過去のエントリは編集せず、新しいエントリのみ追記

**summary/ARCHIVE_20251118-100019.md:**
- DIARY01〜04の要点を時系列・テーマ別に統合したアーカイブ要約
- 新規メンバーはまずこのアーカイブで歴史的背景を把握し、その後 `summary/DIARY05_SUMMARY.md` → `DIARY06.md` を読み進める
