...
1. At the start of each session, review `report/PROGRESS.md`, `report/summary/DIARY01.md`, `report/summary/DIARY02.md`, `report/summary/DIARY03.md`, `report/summary/DIARY04.md`, and `report/DIARY05.md` to understand outstanding work and prior notes.
...
4. When the session ends, update `report/PROGRESS.md` and append a new entry to `report/DIARY05.md` summarizing the work.
