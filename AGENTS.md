...
1. At the start of each session, review `report/PROGRESS.md` and `report/DIARY.md` to understand outstanding work and prior notes.
...
4. When the session ends, update `report/PROGRESS.md` and append a new entry to `report/DIARY.md` summarizing the work.
