...
def plot_single_agent_thesis(df_dict):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/thesis_single_coverage.svg")
    plt.savefig(f"{OUTPUT_DIR}/thesis_single_coverage.png")
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/thesis_single_reward.svg")
    plt.savefig(f"{OUTPUT_DIR}/thesis_single_reward.png")
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/thesis_single_threat.svg")
    plt.savefig(f"{OUTPUT_DIR}/thesis_single_threat.png")
    plt.close()
...
def plot_multi_agent_thesis(df_dict):
    ...
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/thesis_multi_coverage.svg")
    plt.savefig(f"{OUTPUT_DIR}/thesis_multi_coverage.png")
    plt.close()
    ...
    plt.legend(title='Robots')
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/thesis_multi_reward.svg")
    plt.savefig(f"{OUTPUT_DIR}/thesis_multi_reward.png")
    plt.close()
    ...
    plt.legend(title='Robots')
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/thesis_multi_threat.svg")
    plt.savefig(f"{OUTPUT_DIR}/thesis_multi_threat.png")
    plt.close()
