...
class PlaybackSessionSummary(BaseModel):
  ...
  first_recorded_at: datetime | None = Field(None, description="Timestamp of the first recorded frame")
  last_recorded_at: datetime | None = Field(None, description="Timestamp of the most recent frame")
