...
- [Development diary](report/DIARY.md)
...
1. Begin every session by reviewing `report/PROGRESS.md` and `report/DIARY.md` to capture current objectives and context.
...
4. Close each session by updating `report/PROGRESS.md` and logging a new entry in `report/DIARY.md` that summarizes the changes and decisions.
