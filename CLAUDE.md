...
- [Current development diary](report/DIARY05.md)
...
1. Begin every session by reviewing `report/PROGRESS.md`, `report/summary/DIARY01.md`, `report/summary/DIARY02.md`, `report/summary/DIARY03.md`, `report/summary/DIARY04.md`, and `report/DIARY05.md` to capture current objectives and context.
...
4. Close each session by updating `report/PROGRESS.md` and logging a new entry in `report/DIARY05.md` that summarizes the changes and decisions.
