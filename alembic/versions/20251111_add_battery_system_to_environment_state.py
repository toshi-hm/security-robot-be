...
def upgrade() -> None:
    ...
    op.add_column("environmentstate", sa.Column("battery_percentage", sa.Float(), nullable=True))
    op.add_column("environmentstate", sa.Column("is_charging", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("environmentstate", sa.Column("distance_to_charging_station", sa.Integer(), nullable=True))
    op.add_column("environmentstate", sa.Column("charging_station_position_x", sa.Integer(), nullable=True))
    op.add_column("environmentstate", sa.Column("charging_station_position_y", sa.Integer(), nullable=True))
